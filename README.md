...
## Components
  ...
  * CARD DETAIL VIEW FOLDER:
    * CardModal: a modal that displays the detailed view of each card component in the main dashboard.
...
-[Demo](https://github.aig.net/pages/cconcepc/AnalyticsDashboard/)
